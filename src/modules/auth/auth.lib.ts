...
export const loginValidation: Record<ILoginData['email' | 'password'], RegisterOptions> = {
	email: {
...
export const registrationValidation: Record<IRegisterData['email' | 'password'], RegisterOptions> =
	{
		firstName: {},
		lastName: {},
		email: {
